...
def get_input_args():
    ...
    parser.add_argument("--show-pet-labels", action="store_true", default=True)
    parser.add_argument("--show-image-classification", action="store_true", default=True)
    parser.add_argument("--show-is-a-dog", action="store_true", default=True)
    parser.add_argument("--show-statistics", action="store_true", default=True)
